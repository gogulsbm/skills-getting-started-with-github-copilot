...
activities = {
    ...
    "Debate Team": {
        "description": "Engage in debates on various topics and improve public speaking skills",
...
@app.get("/activities")
def get_activities():
    # Return activities with no-cache headers to ensure clients always get fresh data
